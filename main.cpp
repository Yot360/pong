...
/// <credit>
/// CREDIT TO MY FRIEND THIBAUD FOR TEXTURES
/// </credit>
...
int timeBonus = 0;
std::string bonusImg = "assets/speed.png";
int x_ = WIDTH / 2;
int y_ = HEIGHT / 2 - 20;
void spawnBonus() {
    ...
    if (!isSpawned)
    {
        ...
        if ((rand() % 400) == 2) {
            ...
            x_ = rand() % WIDTH - 100 + 100;
            switch (rand() % 3)
            {
            case 1:
                std::cout << "Bonus 1" << std::endl;
                bonusImg = "assets/speed.png";
                isSpawned = true;
                break;
            case 2:
                std::cout << "Bonus 2" << std::endl;
                bonusImg = "assets/size.png";
                isSpawned = true;
                break;
            case 3:
                std::cout << "Bonus 3" << std::endl;
                bonusImg = "assets/freeze.png";
                isSpawned = true;
                break;
            }
        }
    ...
    else
    {
        ...
        if (SDL_HasIntersection(&ball, &bonus_rect)) {
            ...
            if (bonusImg == "assets/speed.png")
            {
                timeBonus = 60 * 5;
                PLAYER_SPEED = 15;
            }
            else if (bonusImg == "assets/size.png") {
                timeBonus = 60 * 5;
                sizeMultiplier = 3;
                l_paddle.h = HEIGHT / sizeMultiplier;
            }
...
void renderMenu() {
    ...
    if (isCredit) {
        ...
        //esc
        writeText("<-- ESC", 35, HEIGHT / 2 + 280, 120, FONT_SIZE + 10);
    }
